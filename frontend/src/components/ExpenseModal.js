...
function ExpenseModal({open, onClose, state, handleChange, handleDateChange, handleDatePaidChange, editMode}) {
  return (
    <Modal open={open} onClose={onClose}>
      ...
      >
        <div>
          ...
          />
          <Button onClick={(event) => handleChange(event, editMode ? EDIT_DATA : PUSH_DATA)}>
            Save
          </Button>
